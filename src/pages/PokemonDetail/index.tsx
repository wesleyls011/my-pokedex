...
export default function PokemonDetailScreen() {
  ...
  function handleOpenCamera() {
    navigation.navigate('PokemonCamera', { id: pokemonId });
  }
  ...
  useEffect(() => {
    if (!isFocused) return;
    setCachedPhotoUri(getCachedPokemonPhoto(pokemonId));
  }, [isFocused, pokemonId]);
    ...
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <View style={styles.header}>
        ...
        {cachedPhotoUri || pokemon.sprites.front_default ? (
          <Image
            source={{ uri: cachedPhotoUri ?? pokemon.sprites.front_default ?? undefined }}
            style={styles.image}
          />
        ) : null}
      </View>
